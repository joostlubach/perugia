...
import { HamLine, MultiSelectAnswer, SketchAnswer, TextAnswer, TraceAnswer } from '../types';
...
export function PlayerPage() {
  ...
  const answer = (value: number | string[][] | SketchAnswer | HamLine | MultiSelectAnswer | TraceAnswer | TextAnswer) => {
    if (!session) return;
