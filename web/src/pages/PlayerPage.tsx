...
import { HamLine, MultiSelectAnswer, PlateAnswer, TextAnswer, TraceAnswer } from '../types';
...
export function PlayerPage() {
  ...
  const answer = (value: number | string[][] | PlateAnswer | HamLine | MultiSelectAnswer | TraceAnswer | TextAnswer) => {
    if (!session) return;
