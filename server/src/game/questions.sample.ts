...
export const sampleQuestions: DistributiveOmit<Question, 'id'>[] = [
  {
    ...
    ...texts('villa'),
    category: 'stay',
    options: ['Villa Octaviani', 'Villa Volta', 'Villa Aureli', 'Villa Cacchelbonto'],
    correctIndex: 2,
    timeLimitSec: 20,
    points: 1000,
  },
  ...
  },
  {
    ...
    category: 'music',
    options: [
      '’k Had ook geen onderbroek aan',
      'Er werd niet opengedaan',
      'Stond langs de autobahn',
      'Ben maar weer teruggegaan',
      'Wat heb ik daar nou weer aan',
      '’k Heb geen APK gedaan',
      'Tralalalalalaan',
      'Ben toch maar verder gegaan',
      'Ik kwam na middernacht aan',
